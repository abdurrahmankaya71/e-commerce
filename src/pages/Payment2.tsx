...
const Payment2: FunctionComponent = () => {
  return (
    <div className="w-full h-[2006px] relative bg-background-white overflow-hidden flex flex-col items-start justify-start pt-[20.4px] px-0 pb-[814.4px] box-border gap-[46.9px] leading-[normal] tracking-[normal] mq1050:h-auto mq750:gap-[23px]">
      <FrameComponent5
